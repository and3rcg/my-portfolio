            ...
            <div key={index} className="flex-none">
              <TooltipProvider>
                <Tooltip delayDuration={100}>
                  <TooltipTrigger><Image src={tech.logo} alt={tech.name} width={112} height={112} className="drop-shadow-lg overflow-x-auto size-16 lg:size-28 cursor-default hover:-translate-y-2 duration-500"/></TooltipTrigger>
